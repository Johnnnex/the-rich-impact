    ...
    <>
        ...
        <section className="expert-section ">
          <div className="md:w-[90%] w-[95%] mx-auto pt-[100px] md:pt-[49px]">
            ...
            <h2 className="mb-[8px] font-clashGrotesk text-[24px] text-[#2D2B4A] wow fadeInDown font-[600]">THE CHALLENGE 😦</h2>
            <p className=" font-clashGrotesk text-[18px] wow fadeIn font-[400] mb-[40px]">

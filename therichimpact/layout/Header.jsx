    ...
    <header className="py-[13px] bg-[#01020F] ">
        <div className="w-[90%] mx-auto flex justify-between">
            ...
            <nav className="flex items-center text-white gap-[74px]">
                <ul className="text-[.8rem] font-[500] font-clashGrotesk gap-[32px] flex">
                    <li className="">OUR EXPERTISE</li>
                    <li className="">PORTFOLIO</li>
                    <li className="">OUR TEAM</li>
                    <li className="">FAQS</li>
                </ul>
                <button className="text-[.8rem] font-[700] font-clashGrotesk w-[150px] rounded-[8px] py-[10px] bg-[#FCA311]">
                    WORK WITH US
                </button>
            </nav>
        </div>

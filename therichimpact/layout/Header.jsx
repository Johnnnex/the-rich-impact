  ...
  return (
    <header className="py-[13px] bg-[#01020F] ">
        <div className="w-[90%] mx-auto flex items-center justify-between">
            ...
            <nav className="bg-black md:bg-transparent absolute z-[1] md:relative ">
                <div className="flex flex-col md:flex-row items-center text-white gap-[30px]">
                    <ul className="text-[18px] font-[500] font-clashGrotesk gap-[2px] flex-col md:flex-row flex">
                        {links}
                    </ul>
